config = {
    'dataset': {
        'name': "aptos",               # name of the dataset. Should match a corresponding variable name found in datasets/config.py
    },
    'model': {
        'name': 'resnet50',                 # name of the model
        'dir': '',              # checkpoint directory where models are stored
        'bases': [],
        'output_dim':5,                             # list of optional model paths. Empty by default
    },
