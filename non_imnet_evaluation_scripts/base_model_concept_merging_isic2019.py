...
def evaluate_pair_models(eval_type, models, config, split, csv_file):
...
if __name__ == "__main__":
    ...
    run_pairs = [['/home/santoshsanjeev/MedMerge/logs/train_val/ISIC19/Mar07_23-53-41_BioMedIA-A5000ResNet50_ImageNet_and_HAM_to_ISIC_WeightedKernelAvgModel_Full_FineTuning/last.ckpt','/home/santoshsanjeev/MedMerge/logs/train_val/ISIC19/Mar07_23-53-41_BioMedIA-A5000ResNet50_ImageNet_and_HAM_to_ISIC_WeightedKernelAvgModel_Full_FineTuning/last.ckpt']]
    csv_file = os.path.join(
        './csvs',
        raw_config['dataset']['name'],
        raw_config['model']['name'],
